...
def list_newer(start_date, download):
    while start_date < datetime.datetime.today():
        start_date, employees = get_same_or_newer(start_date, download)
...
def main():
    ...
    download = get_file_lines(FILE_URL)
    list_newer(start_date, download)
